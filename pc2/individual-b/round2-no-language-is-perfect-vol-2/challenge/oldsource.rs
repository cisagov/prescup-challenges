...
impl GameState {
    ...
    fn buy_items(&mut self, item_id: Goods, number: u64) -> BuyResult {
        ...
        // NOTE: It used to be possible to exploit this multiplication by
        // finding a common multiple of the cost and 2^64 and dividing out 2^64.
        // He changed how it works now...
