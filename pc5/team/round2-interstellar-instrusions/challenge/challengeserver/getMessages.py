...
inbox_file_path = '/home/user/c21/inbox'
output_directory = '/home/user/c21/messages/'
...
# split inbox records
message_records = inbox_content.split("From it-admin@merch.codes")
...
for index, message_record in enumerate(message_records):
    message = "From it-admin@merch.codes" + message_record.strip()
