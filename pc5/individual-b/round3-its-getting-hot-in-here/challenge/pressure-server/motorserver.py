...
def run_async_server():
    ...
    identity.ProductCode = "Product Code=ScadaAtmoshpereMotorControler"
    identity.VendorUrl = "http://scada.merch.codes"
    identity.ProductName = "Product Name=Atmosphere Controller Server"
    identity.ModelName = "Atmosphere Controller"
