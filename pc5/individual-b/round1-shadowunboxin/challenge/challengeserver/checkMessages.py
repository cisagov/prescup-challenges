...
message_directory = '/home/user/c36/messages/'
output_directory = '/home/user/c36/output/'
status_file = '/home/user/c36/status.txt'
...
for filename in os.listdir(message_directory):
    if filename.endswith('.txt'):
        ...
        if 'Sender: customer@merch.codes' not in message_content:
            status = max(status, '1')
            continue
        
        target_link = 'http://order15887.pdf'
