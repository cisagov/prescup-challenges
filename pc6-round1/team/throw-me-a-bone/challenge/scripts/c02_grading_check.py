...
def main():
    ip_list = ["10.3.3.3", "10.3.3.10", "10.1.1.151", "10.2.2.151", "10.2.2.152", "10.2.2.153"]
    for ip in ip_list:
        results = grading_system_check.check_system(ip)

    if any("Fail" in value for value in results.values()):
