...
- [T1262](https://niccs.cisa.gov/tools/nice-framework): Identify programming code flaws.
...
![A simple network diagram showing 4 hosts: channel.us, maelstrom.us, maw.us, and kessel.us. There is an arrow pointing from channel to maelstrom (labelled /maelstrom), maelstrom to maw (labelled /maw), and maw to kessel (labelled /kessel), representing each of the proxy hops.](/static/themes/pccc/imgs/KesselRun.png "Network Diagram for 'Kessel Run'")
