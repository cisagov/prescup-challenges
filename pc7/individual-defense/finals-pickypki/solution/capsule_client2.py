...
def make_client_csr_der(cn: str) -> bytes:
...
def main():
    ...
    csr_der = make_client_csr_der("graderclient")
    ...
    with open("/tmp/client.crt","wb") as f: f.write(leaf)
    print("[OK] wrote /tmp/client.crt and /tmp/client.key")
