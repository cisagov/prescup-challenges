    ...
    <div class="container">
     ...
     // Check if the logged-in user is "bcampbell"
            if ($_SESSION['username'] === 'bcampbell') {
                echo "<h1 style='color:DodgerBlue;'>bcampbell password cracked token = bc########</p>";
            }

            // Check if user is admin
            if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']) {
                echo "<h1 style='color:DodgerBlue;'>You are logged in as an admin, here is your token: ia######## </h1>";
            }
        } else {
