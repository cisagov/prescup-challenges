...
" example_solution.py
sed -i'' "15i\\\# fields of interest for each protocol -- will be dataframe column names later" example_solution.py
sed -i'' "s/'data','date'.*/'data',\ 'stream',\ 'date','time']/g" example_solution.py
sed -i'' "21i\\\# command to use in tshark to process pcap files" example_solution.py
